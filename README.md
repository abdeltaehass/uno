...
Prefer a guided setup? Start here:

* **[Uno Platform Templates](https://aka.platform.uno/templates)**: Browse project templates and select the right app type for your target platforms.
* **[Uno Platform Learn](https://aka.platform.uno/learn)**: Follow structured learning paths and curated tutorials.
